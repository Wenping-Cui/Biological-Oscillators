...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [], 
        "name": "Cython_lib.Brusselator_cython", 
        "sources": [
            "Cython_lib/Brusselator_cython.pyx"
        ]
    }, 
    "module_name": "Cython_lib.Brusselator_cython"
}
END: Cython Metadata */
...
#define __PYX_HAVE__Cython_lib__Brusselator_cython
#define __PYX_HAVE_API__Cython_lib__Brusselator_cython
#include <string.h>
#include <stdio.h>
...
/* "Cython_lib/Brusselator_cython.pyx":27
 * 
 * DTYPE = np.int
 ...
 * DTYPE2 = np.float
 */
typedef __pyx_t_5numpy_int_t __pyx_t_10Cython_lib_18Brusselator_cython_DTYPE_t;

/* "Cython_lib/Brusselator_cython.pyx":30
 * 
 * DTYPE2 = np.float
 ...
 * 
 */
typedef __pyx_t_5numpy_float_t __pyx_t_10Cython_lib_18Brusselator_cython_DTYPE2_t;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'Cython_lib.Brusselator_cython' */
...
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_10Cython_lib_18Brusselator_cython_DTYPE2_t = { "DTYPE2_t", NULL, sizeof(__pyx_t_10Cython_lib_18Brusselator_cython_DTYPE2_t), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "Cython_lib.Brusselator_cython"
int __pyx_module_is_main_Cython_lib__Brusselator_cython = 0;

/* Implementation of 'Cython_lib.Brusselator_cython' */
...
static const char __pyx_k_Brusselator_loopProgress[] = "Brusselator_loopProgress";
static const char __pyx_k_time_x_y_counter_entropy[] = "time, x, y, counter, entropy \n";
static const char __pyx_k_Brusse_Barato_loopProgress[] = "Brusse_Barato_loopProgress";
static const char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static const char __pyx_k_Cython_lib_Brusselator_cython[] = "Cython_lib.Brusselator_cython";
static const char __pyx_k_numpy_core_multiarray_failed_to[] = "numpy.core.multiarray failed to import";
static const char __pyx_k_unknown_dtype_code_in_numpy_pxd[] = "unknown dtype code in numpy.pxd (%d)";
static const char __pyx_k_Cython_lib_Brusselator_cython_py[] = "Cython_lib/Brusselator_cython.pyx";
static const char __pyx_k_Format_string_allocated_too_shor[] = "Format string allocated too short, see comment in numpy.pxd";
static const char __pyx_k_Non_native_byte_order_not_suppor[] = "Non-native byte order not supported";
static const char __pyx_k_ndarray_is_not_Fortran_contiguou[] = "ndarray is not Fortran contiguous";
static const char __pyx_k_numpy_core_umath_failed_to_impor[] = "numpy.core.umath failed to import";
static const char __pyx_k_Format_string_allocated_too_shor_2[] = "Format string allocated too short.";
static PyObject *__pyx_n_s_Brusse_Barato_loopProgress;
static PyObject *__pyx_n_s_Brusselator_loopProgress;
static PyObject *__pyx_n_s_Cython_lib_Brusselator_cython;
static PyObject *__pyx_kp_s_Cython_lib_Brusselator_cython_py;
...
static PyObject *__pyx_kp_s_time_x_y_counter_entropy;
...
static PyObject *__pyx_pf_10Cython_lib_18Brusselator_cython_Brusse_Barato_loopProgress(CYTHON_UNUSED PyObject *__pyx_self, char *__pyx_v_fname1, PyObject *__pyx_v_fname2, CYTHON_UNUSED PyObject *__pyx_v_fname3, int __pyx_v_numberOfReactions, PyObject *__pyx_v_win_threshold1, PyObject *__pyx_v_win_threshold2, PyArrayObject *__pyx_v_reactionrate, PyArrayObject *__pyx_v_par_ini); /* proto */
static PyObject *__pyx_pf_10Cython_lib_18Brusselator_cython_2Brusselator_loopProgress(CYTHON_UNUSED PyObject *__pyx_self, char *__pyx_v_fname1, PyObject *__pyx_v_fname2, CYTHON_UNUSED PyObject *__pyx_v_fname3, int __pyx_v_numberOfReactions, PyObject *__pyx_v_win_threshold1, PyObject *__pyx_v_win_threshold2, PyArrayObject *__pyx_v_reactionrate, PyArrayObject *__pyx_v_par_ini); /* proto */
...
/* "Cython_lib/Brusselator_cython.pyx":33
 * @cython.cdivision(True)
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_10Cython_lib_18Brusselator_cython_1Brusse_Barato_loopProgress(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_10Cython_lib_18Brusselator_cython_1Brusse_Barato_loopProgress = {"Brusse_Barato_loopProgress", (PyCFunction)__pyx_pw_10Cython_lib_18Brusselator_cython_1Brusse_Barato_loopProgress, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_10Cython_lib_18Brusselator_cython_1Brusse_Barato_loopProgress(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  char *__pyx_v_fname1;
  PyObject *__pyx_v_fname2 = 0;
  CYTHON_UNUSED PyObject *__pyx_v_fname3 = 0;
  ...
  PyArrayObject *__pyx_v_par_ini = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("Brusse_Barato_loopProgress (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_fname2)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("Brusse_Barato_loopProgress", 1, 8, 8, 1); __PYX_ERR(0, 33, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_fname3)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Brusse_Barato_loopProgress", 1, 8, 8, 2); __PYX_ERR(0, 33, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_numberOfReactions)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Brusse_Barato_loopProgress", 1, 8, 8, 3); __PYX_ERR(0, 33, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_win_threshold1)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Brusse_Barato_loopProgress", 1, 8, 8, 4); __PYX_ERR(0, 33, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_win_threshold2)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Brusse_Barato_loopProgress", 1, 8, 8, 5); __PYX_ERR(0, 33, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_reactionrate)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Brusse_Barato_loopProgress", 1, 8, 8, 6); __PYX_ERR(0, 33, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_par_ini)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("Brusse_Barato_loopProgress", 1, 8, 8, 7); __PYX_ERR(0, 33, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "Brusse_Barato_loopProgress") < 0)) __PYX_ERR(0, 33, __pyx_L3_error)
      }
    ...
    __pyx_v_par_ini = ((PyArrayObject *)values[7]);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("Brusse_Barato_loopProgress", 1, 8, 8, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 33, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("Cython_lib.Brusselator_cython.Brusse_Barato_loopProgress", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_par_ini), __pyx_ptype_5numpy_ndarray, 1, "par_ini", 0))) __PYX_ERR(0, 33, __pyx_L1_error)
  __pyx_r = __pyx_pf_10Cython_lib_18Brusselator_cython_Brusse_Barato_loopProgress(__pyx_self, __pyx_v_fname1, __pyx_v_fname2, __pyx_v_fname3, __pyx_v_numberOfReactions, __pyx_v_win_threshold1, __pyx_v_win_threshold2, __pyx_v_reactionrate, __pyx_v_par_ini);
...
static PyObject *__pyx_pf_10Cython_lib_18Brusselator_cython_Brusse_Barato_loopProgress(CYTHON_UNUSED PyObject *__pyx_self, char *__pyx_v_fname1, PyObject *__pyx_v_fname2, CYTHON_UNUSED PyObject *__pyx_v_fname3, int __pyx_v_numberOfReactions, PyObject *__pyx_v_win_threshold1, PyObject *__pyx_v_win_threshold2, PyArrayObject *__pyx_v_reactionrate, PyArrayObject *__pyx_v_par_ini) {
  double __pyx_v_a;
  double __pyx_v_b;
  double __pyx_v_k1;
  double __pyx_v_k2;
  ...
  double __pyx_v_step;
  double __pyx_v_v;
  CYTHON_UNUSED double __pyx_v_time1;
  int __pyx_v_counter;
  CYTHON_UNUSED int __pyx_v_counter1;
  int __pyx_v_i;
  int __pyx_v_h;
  CYTHON_UNUSED double __pyx_v_action_rate[6];
  double __pyx_v_time0;
  double __pyx_v_current[6];
  ...
  __Pyx_LocalBuf_ND __pyx_pybuffernd_par_ini;
  __Pyx_Buffer __pyx_pybuffer_par_ini;
  ...
  int __pyx_t_25;
  int __pyx_t_26;
  __Pyx_RefNannySetupContext("Brusse_Barato_loopProgress", 0);
  ...
  __pyx_pybuffer_par_ini.pybuffer.buf = NULL;
  __pyx_pybuffer_par_ini.refcount = 0;
  __pyx_pybuffernd_par_ini.data = NULL;
  __pyx_pybuffernd_par_ini.rcbuffer = &__pyx_pybuffer_par_ini;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_reactionrate.rcbuffer->pybuffer, (PyObject*)__pyx_v_reactionrate, &__Pyx_TypeInfo_nn___pyx_t_10Cython_lib_18Brusselator_cython_DTYPE2_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 33, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_par_ini.rcbuffer->pybuffer, (PyObject*)__pyx_v_par_ini, &__Pyx_TypeInfo_nn___pyx_t_10Cython_lib_18Brusselator_cython_DTYPE2_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 33, __pyx_L1_error)
  }
  ...
  /* "Cython_lib/Brusselator_cython.pyx":38
 ...
 */
  if ((likely(PyTuple_CheckExact(((PyObject *)__pyx_v_par_ini)))) || (PyList_CheckExact(((PyObject *)__pyx_v_par_ini)))) {
    ...
    Py_ssize_t index = -1;
    PyObject** temps[4] = {&__pyx_t_1,&__pyx_t_2,&__pyx_t_3,&__pyx_t_4};
    __pyx_t_5 = PyObject_GetIter(((PyObject *)__pyx_v_par_ini)); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 38, __pyx_L1_error)
    ...
    if (__Pyx_IternextUnpackEndCheck(__pyx_t_6(__pyx_t_5), 4) < 0) __PYX_ERR(0, 38, __pyx_L1_error)
    __pyx_t_6 = NULL;
  ...
  __pyx_t_10 = __pyx_PyFloat_AsDouble(__pyx_t_4); if (unlikely((__pyx_t_10 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 38, __pyx_L1_error)
  ...
  /* "Cython_lib/Brusselator_cython.pyx":39
 * 
 *     x, y, v, step = par_ini
 *     a, b, k1, k2, k3, k_1, k_2, k_3 = reactionrate             # <<<<<<<<<<<<<<
 *     File1 = open(fname1,"w")
 ...
 */
  if ((likely(PyTuple_CheckExact(((PyObject *)__pyx_v_reactionrate)))) || (PyList_CheckExact(((PyObject *)__pyx_v_reactionrate)))) {
    ...
    {
      Py_ssize_t i;
      PyObject** temps[8] = {&__pyx_t_4,&__pyx_t_3,&__pyx_t_2,&__pyx_t_1,&__pyx_t_5,&__pyx_t_11,&__pyx_t_12,&__pyx_t_13};
      for (i=0; i < 8; i++) {
    ...
    Py_ssize_t index = -1;
    PyObject** temps[8] = {&__pyx_t_4,&__pyx_t_3,&__pyx_t_2,&__pyx_t_1,&__pyx_t_5,&__pyx_t_11,&__pyx_t_12,&__pyx_t_13};
    __pyx_t_14 = PyObject_GetIter(((PyObject *)__pyx_v_reactionrate)); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 39, __pyx_L1_error)
    ...
    if (__Pyx_IternextUnpackEndCheck(__pyx_t_6(__pyx_t_14), 8) < 0) __PYX_ERR(0, 39, __pyx_L1_error)
    __pyx_t_6 = NULL;
  ...
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_9 = __pyx_PyFloat_AsDouble(__pyx_t_3); if (unlikely((__pyx_t_9 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 39, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_16 = __pyx_PyFloat_AsDouble(__pyx_t_11); if (unlikely((__pyx_t_16 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 39, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
  __pyx_t_17 = __pyx_PyFloat_AsDouble(__pyx_t_12); if (unlikely((__pyx_t_17 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 39, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
  __pyx_t_18 = __pyx_PyFloat_AsDouble(__pyx_t_13); if (unlikely((__pyx_t_18 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 39, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
  __pyx_v_a = __pyx_t_10;
  __pyx_v_b = __pyx_t_9;
  __pyx_v_k1 = __pyx_t_8;
  __pyx_v_k2 = __pyx_t_7;
  __pyx_v_k3 = __pyx_t_15;
  __pyx_v_k_1 = __pyx_t_16;
  __pyx_v_k_2 = __pyx_t_17;
  __pyx_v_k_3 = __pyx_t_18;

  /* "Cython_lib/Brusselator_cython.pyx":40
 *     x, y, v, step = par_ini
 *     a, b, k1, k2, k3, k_1, k_2, k_3 = reactionrate
 *     File1 = open(fname1,"w")             # <<<<<<<<<<<<<<
 *     File1.write('time, x, y, counter, entropy \n')
 ...
 */
  ...
  /* "Cython_lib/Brusselator_cython.pyx":41
 *     a, b, k1, k2, k3, k_1, k_2, k_3 = reactionrate
 *     File1 = open(fname1,"w")
 *     File1.write('time, x, y, counter, entropy \n')             # <<<<<<<<<<<<<<
 *     File2 = open(fname2,"w")
 ...
 */
  ...
  /* "Cython_lib/Brusselator_cython.pyx":42
 *     File1 = open(fname1,"w")
 *     File1.write('time, x, y, counter, entropy \n')
 *     File2 = open(fname2,"w")             # <<<<<<<<<<<<<<
 *     File2.write('time, counter, duration \n')
 ...
 */
  ...
  PyTuple_SET_ITEM(__pyx_t_12, 0, __pyx_v_fname2);
  __Pyx_INCREF(__pyx_n_s_w);
  __Pyx_GIVEREF(__pyx_n_s_w);
  PyTuple_SET_ITEM(__pyx_t_12, 1, __pyx_n_s_w);
  ...
  /* "Cython_lib/Brusselator_cython.pyx":43
 *     File1.write('time, x, y, counter, entropy \n')
 *     File2 = open(fname2,"w")
 *     File2.write('time, counter, duration \n')             # <<<<<<<<<<<<<<
 *     entropy=0;
 ...
 */
  ...
  /* "Cython_lib/Brusselator_cython.pyx":44
 *     File2 = open(fname2,"w")
 *     File2.write('time, counter, duration \n')
 *     entropy=0;             # <<<<<<<<<<<<<<
 *     action_rate =[a*k1, k_1*x, k2*b, k_2*y, k3*x**2*y/v**2,k_3*x**3/v**2]
 ...
 */
  ...
  /* "Cython_lib/Brusselator_cython.pyx":45
 *     File2.write('time, counter, duration \n')
 *     entropy=0;
 *     action_rate =[a*k1, k_1*x, k2*b, k_2*y, k3*x**2*y/v**2,k_3*x**3/v**2]             # <<<<<<<<<<<<<<
 *     i=0; time=0.00; counter=0; time0=0; time1=0; counter1=0;
 ...
 */
  __pyx_t_19[0] = (__pyx_v_a * __pyx_v_k1);
  __pyx_t_19[1] = (__pyx_v_k_1 * __pyx_v_x);
  __pyx_t_19[2] = (__pyx_v_k2 * __pyx_v_b);
  __pyx_t_19[3] = (__pyx_v_k_2 * __pyx_v_y);
  __pyx_t_19[4] = (((__pyx_v_k3 * pow(__pyx_v_x, 2.0)) * __pyx_v_y) / pow(__pyx_v_v, 2.0));
  ...
  /* "Cython_lib/Brusselator_cython.pyx":46
 *     entropy=0;
 *     action_rate =[a*k1, k_1*x, k2*b, k_2*y, k3*x**2*y/v**2,k_3*x**3/v**2]
 *     i=0; time=0.00; counter=0; time0=0; time1=0; counter1=0;             # <<<<<<<<<<<<<<
 *     for i in range(numberOfReactions):
 ...
 */
  ...
  /* "Cython_lib/Brusselator_cython.pyx":47
 *     action_rate =[a*k1, k_1*x, k2*b, k_2*y, k3*x**2*y/v**2,k_3*x**3/v**2]
 *     i=0; time=0.00; counter=0; time0=0; time1=0; counter1=0;
 *     for i in range(numberOfReactions):             # <<<<<<<<<<<<<<
 *         e_s=0;
 *         entropy_sum=0;
 */
  __pyx_t_20 = __pyx_v_numberOfReactions;
  for (__pyx_t_21 = 0; __pyx_t_21 < __pyx_t_20; __pyx_t_21+=1) {
    __pyx_v_i = __pyx_t_21;

    /* "Cython_lib/Brusselator_cython.pyx":48
 *     i=0; time=0.00; counter=0; time0=0; time1=0; counter1=0;
 *     for i in range(numberOfReactions):
 *         e_s=0;             # <<<<<<<<<<<<<<
 *         entropy_sum=0;
 ...
 */
    ...
    /* "Cython_lib/Brusselator_cython.pyx":49
 *     for i in range(numberOfReactions):
 *         e_s=0;
 *         entropy_sum=0;             # <<<<<<<<<<<<<<
 *         while time < i/step:
 ...
 */
    ...
    /* "Cython_lib/Brusselator_cython.pyx":50
 *         e_s=0;
 *         entropy_sum=0;
 *         while time < i/step:             # <<<<<<<<<<<<<<
 *               x0=x;
 ...
 */
    while (1) {
      ...
      /* "Cython_lib/Brusselator_cython.pyx":51
 *         entropy_sum=0;
 *         while time < i/step:
 *               x0=x;             # <<<<<<<<<<<<<<
 *               y0=y;
 ...
 */
      ...
      /* "Cython_lib/Brusselator_cython.pyx":52
 *         while time < i/step:
 *               x0=x;
 *               y0=y;             # <<<<<<<<<<<<<<
 *               action_rate =[a*k1, k_1*x, k2*b, k_2*y, k3*x**2*y/v**2,k_3*x**3/v**2]
 ...
 */
      ...
      /* "Cython_lib/Brusselator_cython.pyx":53
 *               x0=x;
 *               y0=y;
 *               action_rate =[a*k1, k_1*x, k2*b, k_2*y, k3*x**2*y/v**2,k_3*x**3/v**2]             # <<<<<<<<<<<<<<
 *               current=[a*k1, k_1*x, k2*b, k_2*y, k3*x**2*y/v**2,k_3*x**3/v**2]
 *               entropy=0;
 */
      __pyx_t_23[0] = (__pyx_v_a * __pyx_v_k1);
      __pyx_t_23[1] = (__pyx_v_k_1 * __pyx_v_x);
      __pyx_t_23[2] = (__pyx_v_k2 * __pyx_v_b);
      __pyx_t_23[3] = (__pyx_v_k_2 * __pyx_v_y);
      __pyx_t_23[4] = (((__pyx_v_k3 * pow(__pyx_v_x, 2.0)) * __pyx_v_y) / pow(__pyx_v_v, 2.0));
      ...
      /* "Cython_lib/Brusselator_cython.pyx":54
 *               y0=y;
 *               action_rate =[a*k1, k_1*x, k2*b, k_2*y, k3*x**2*y/v**2,k_3*x**3/v**2]
 *               current=[a*k1, k_1*x, k2*b, k_2*y, k3*x**2*y/v**2,k_3*x**3/v**2]             # <<<<<<<<<<<<<<
 *               entropy=0;
 *               for h in range(3):
 */
      __pyx_t_24[0] = (__pyx_v_a * __pyx_v_k1);
      __pyx_t_24[1] = (__pyx_v_k_1 * __pyx_v_x);
      __pyx_t_24[2] = (__pyx_v_k2 * __pyx_v_b);
      __pyx_t_24[3] = (__pyx_v_k_2 * __pyx_v_y);
      __pyx_t_24[4] = (((__pyx_v_k3 * pow(__pyx_v_x, 2.0)) * __pyx_v_y) / pow(__pyx_v_v, 2.0));
      ...
      /* "Cython_lib/Brusselator_cython.pyx":55
 *               action_rate =[a*k1, k_1*x, k2*b, k_2*y, k3*x**2*y/v**2,k_3*x**3/v**2]
 *               current=[a*k1, k_1*x, k2*b, k_2*y, k3*x**2*y/v**2,k_3*x**3/v**2]
 *               entropy=0;             # <<<<<<<<<<<<<<
 *               for h in range(3):
 ...
 */
      ...
      /* "Cython_lib/Brusselator_cython.pyx":56
 *               current=[a*k1, k_1*x, k2*b, k_2*y, k3*x**2*y/v**2,k_3*x**3/v**2]
 *               entropy=0;
 *               for h in range(3):             # <<<<<<<<<<<<<<
 *                   entropy=entropy+(current[2*h]-current[2*h+1])*log(current[2*h]/current[2*h+1])
 ...
 */
      for (__pyx_t_25 = 0; __pyx_t_25 < 3; __pyx_t_25+=1) {
        ...
        /* "Cython_lib/Brusselator_cython.pyx":57
 *               entropy=0;
 *               for h in range(3):
 *                   entropy=entropy+(current[2*h]-current[2*h+1])*log(current[2*h]/current[2*h+1])             # <<<<<<<<<<<<<<
 *               if entropy!=float('NaN') and entropy!=float('Inf'):
 ...
 */
      ...
      /* "Cython_lib/Brusselator_cython.pyx":58
 *               for h in range(3):
 *                   entropy=entropy+(current[2*h]-current[2*h+1])*log(current[2*h]/current[2*h+1])
 *               if entropy!=float('NaN') and entropy!=float('Inf'):             # <<<<<<<<<<<<<<
 *                  entropy_sum=entropy_sum+entropy
 ...
 */
      ...
      if (__pyx_t_22) {
        ...
        /* "Cython_lib/Brusselator_cython.pyx":59
 *                   entropy=entropy+(current[2*h]-current[2*h+1])*log(current[2*h]/current[2*h+1])
 *               if entropy!=float('NaN') and entropy!=float('Inf'):
 *                  entropy_sum=entropy_sum+entropy             # <<<<<<<<<<<<<<
 *                  e_s=e_s+1
 ...
 */
        ...
        /* "Cython_lib/Brusselator_cython.pyx":60
 *               if entropy!=float('NaN') and entropy!=float('Inf'):
 *                  entropy_sum=entropy_sum+entropy
 *                  e_s=e_s+1             # <<<<<<<<<<<<<<
 *               a0=a*k1+k_1*x+k2*b+k_2*y+k3*x**2*y/v**2+k_3*x**3/v**2
 ...
 */
      ...
      /* "Cython_lib/Brusselator_cython.pyx":61
 *                  entropy_sum=entropy_sum+entropy
 *                  e_s=e_s+1
 *               a0=a*k1+k_1*x+k2*b+k_2*y+k3*x**2*y/v**2+k_3*x**3/v**2             # <<<<<<<<<<<<<<
 *               #print 'sum of rates', sum_rate
 ...
 */
      ...
      /* "Cython_lib/Brusselator_cython.pyx":63
 *               a0=a*k1+k_1*x+k2*b+k_2*y+k3*x**2*y/v**2+k_3*x**3/v**2
 *               #print 'sum of rates', sum_rate
 *               rr[0], rr[1]=(rand()+1.00)/(RAND_MAX + 1.00), (rand()+1.00)/(RAND_MAX + 1.00)             # <<<<<<<<<<<<<<
 ...
 * ################################################################################################################
 */
      __pyx_t_18 = ((rand() + 1.00) / (RAND_MAX + 1.00));
      __pyx_t_17 = ((rand() + 1.00) / (RAND_MAX + 1.00));
      (__pyx_v_rr[0]) = __pyx_t_18;
      (__pyx_v_rr[1]) = __pyx_t_17;

      /* "Cython_lib/Brusselator_cython.pyx":64
 *               #print 'sum of rates', sum_rate
 *               rr[0], rr[1]=(rand()+1.00)/(RAND_MAX + 1.00), (rand()+1.00)/(RAND_MAX + 1.00)
 *               time=time+(1.000/a0)*log(1.000/rr[0]);             # <<<<<<<<<<<<<<
 * ################################################################################################################
 ...
 */
      ...
      /* "Cython_lib/Brusselator_cython.pyx":66
 *               time=time+(1.000/a0)*log(1.000/rr[0]);
 * ################################################################################################################
 *               if rr[1]*a0<a*k1:   # a*k1             # <<<<<<<<<<<<<<
 *                  x=x+1
 ...
 */
      ...
      if (__pyx_t_22) {
        ...
        /* "Cython_lib/Brusselator_cython.pyx":67
 * ################################################################################################################
 *               if rr[1]*a0<a*k1:   # a*k1
 *                  x=x+1             # <<<<<<<<<<<<<<
 *               elif rr[1]*a0<a*k1+k_1*x:   # k_1*x
 ...
 */
      ...
      /* "Cython_lib/Brusselator_cython.pyx":68
 *               if rr[1]*a0<a*k1:   # a*k1
 *                  x=x+1
 *               elif rr[1]*a0<a*k1+k_1*x:   # k_1*x             # <<<<<<<<<<<<<<
 *                  x=x-1
 ...
 */
      ...
      if (__pyx_t_22) {
        ...
        /* "Cython_lib/Brusselator_cython.pyx":69
 *                  x=x+1
 *               elif rr[1]*a0<a*k1+k_1*x:   # k_1*x
 *                  x=x-1             # <<<<<<<<<<<<<<
 *               elif rr[1]*a0<a*k1+k_1*x+k2*b:# k2*b
 ...
 */
      ...
      /* "Cython_lib/Brusselator_cython.pyx":70
 *               elif rr[1]*a0<a*k1+k_1*x:   # k_1*x
 *                  x=x-1
 *               elif rr[1]*a0<a*k1+k_1*x+k2*b:# k2*b             # <<<<<<<<<<<<<<
 *                  y=y+1
 ...
 */
      ...
      if (__pyx_t_22) {
        ...
        /* "Cython_lib/Brusselator_cython.pyx":71
 *                  x=x-1
 *               elif rr[1]*a0<a*k1+k_1*x+k2*b:# k2*b
 *                  y=y+1             # <<<<<<<<<<<<<<
 *               elif rr[1]*a0<a*k1+k_1*x+k2*b+k_2*y:   #k_2*y
 ...
 */
      ...
      /* "Cython_lib/Brusselator_cython.pyx":72
 *               elif rr[1]*a0<a*k1+k_1*x+k2*b:# k2*b
 *                  y=y+1
 *               elif rr[1]*a0<a*k1+k_1*x+k2*b+k_2*y:   #k_2*y             # <<<<<<<<<<<<<<
 *                  y=y-1;
 ...
 */
      ...
      if (__pyx_t_22) {
        ...
        /* "Cython_lib/Brusselator_cython.pyx":73
 *                  y=y+1
 *               elif rr[1]*a0<a*k1+k_1*x+k2*b+k_2*y:   #k_2*y
 *                  y=y-1;             # <<<<<<<<<<<<<<
 *               elif rr[1]*a0<a*k1+k_1*x+k2*b+k_2*y+k3*x**2*y/v**2: #k3*x**2*y/v**2
 ...
 */
      ...
      /* "Cython_lib/Brusselator_cython.pyx":74
 *               elif rr[1]*a0<a*k1+k_1*x+k2*b+k_2*y:   #k_2*y
 *                  y=y-1;
 *               elif rr[1]*a0<a*k1+k_1*x+k2*b+k_2*y+k3*x**2*y/v**2: #k3*x**2*y/v**2             # <<<<<<<<<<<<<<
 *                  x=x+1
 ...
 */
      ...
      if (__pyx_t_22) {
        ...
        /* "Cython_lib/Brusselator_cython.pyx":75
 *                  y=y-1;
 *               elif rr[1]*a0<a*k1+k_1*x+k2*b+k_2*y+k3*x**2*y/v**2: #k3*x**2*y/v**2
 *                  x=x+1             # <<<<<<<<<<<<<<
 *                  y=y-1
 ...
 */
        ...
        /* "Cython_lib/Brusselator_cython.pyx":76
 *               elif rr[1]*a0<a*k1+k_1*x+k2*b+k_2*y+k3*x**2*y/v**2: #k3*x**2*y/v**2
 *                  x=x+1
 *                  y=y-1             # <<<<<<<<<<<<<<
 *               elif rr[1]*a0<a0: # k_3*x**3/v**2
 ...
 */
      ...
      /* "Cython_lib/Brusselator_cython.pyx":77
 *                  x=x+1
 *                  y=y-1
 *               elif rr[1]*a0<a0: # k_3*x**3/v**2             # <<<<<<<<<<<<<<
 *                  x=x-1
 ...
 */
      ...
      if (__pyx_t_22) {
        ...
        /* "Cython_lib/Brusselator_cython.pyx":78
 *                  y=y-1
 *               elif rr[1]*a0<a0: # k_3*x**3/v**2
 *                  x=x-1             # <<<<<<<<<<<<<<
 *                  y=y+1
 ...
 */
        ...
        /* "Cython_lib/Brusselator_cython.pyx":79
 *               elif rr[1]*a0<a0: # k_3*x**3/v**2
 *                  x=x-1
 *                  y=y+1             # <<<<<<<<<<<<<<
 * ################################################################################################################
 ...
 */
      ...
      /* "Cython_lib/Brusselator_cython.pyx":81
 *                  y=y+1
 * ################################################################################################################
 *               if x0 == win_threshold1 and y < win_threshold2 and x==win_threshold1+1 and y0 < win_threshold2:             # <<<<<<<<<<<<<<
 *                   counter=counter+1;
 ...
 */
      ...
      if (__pyx_t_22) {
        ...
        /* "Cython_lib/Brusselator_cython.pyx":82
 * ################################################################################################################
 *               if x0 == win_threshold1 and y < win_threshold2 and x==win_threshold1+1 and y0 < win_threshold2:
 *                   counter=counter+1;             # <<<<<<<<<<<<<<
 *                   File2.write(str(time)+', '+str(counter)+','+ str(time-time0)+'\n')
 ...
 */
        ...
        /* "Cython_lib/Brusselator_cython.pyx":83
 *               if x0 == win_threshold1 and y < win_threshold2 and x==win_threshold1+1 and y0 < win_threshold2:
 *                   counter=counter+1;
 *                   File2.write(str(time)+', '+str(counter)+','+ str(time-time0)+'\n')             # <<<<<<<<<<<<<<
 *                   time0=time
 ...
 */
        ...
        /* "Cython_lib/Brusselator_cython.pyx":84
 *                   counter=counter+1;
 *                   File2.write(str(time)+', '+str(counter)+','+ str(time-time0)+'\n')
 *                   time0=time             # <<<<<<<<<<<<<<
 *               if x0 == win_threshold1+1 and y < win_threshold2 and x==win_threshold1 and y0 < win_threshold2:
 ...
 */
      ...
      /* "Cython_lib/Brusselator_cython.pyx":85
 *                   File2.write(str(time)+', '+str(counter)+','+ str(time-time0)+'\n')
 *                   time0=time
 *               if x0 == win_threshold1+1 and y < win_threshold2 and x==win_threshold1 and y0 < win_threshold2:             # <<<<<<<<<<<<<<
 *                   counter=counter-1;
 ...
 */
      ...
      if (__pyx_t_22) {
        ...
        /* "Cython_lib/Brusselator_cython.pyx":86
 *                   time0=time
 *               if x0 == win_threshold1+1 and y < win_threshold2 and x==win_threshold1 and y0 < win_threshold2:
 *                   counter=counter-1;             # <<<<<<<<<<<<<<
 *                   File2.write(str(time)+', '+str(counter)+'\n')
 ...
 */
        ...
        /* "Cython_lib/Brusselator_cython.pyx":87
 *               if x0 == win_threshold1+1 and y < win_threshold2 and x==win_threshold1 and y0 < win_threshold2:
 *                   counter=counter-1;
 *                   File2.write(str(time)+', '+str(counter)+'\n')             # <<<<<<<<<<<<<<
 *         output1 = str(time)+','+str(x)+','+str(y)+','+str(counter) +','+str(entropy_sum/e_s)+'\n';
 ...
 */
    ...
    /* "Cython_lib/Brusselator_cython.pyx":88
 *                   counter=counter-1;
 *                   File2.write(str(time)+', '+str(counter)+'\n')
 *         output1 = str(time)+','+str(x)+','+str(y)+','+str(counter) +','+str(entropy_sum/e_s)+'\n';             # <<<<<<<<<<<<<<
 *         File1.write(output1)
 ...
 */
    ...
    /* "Cython_lib/Brusselator_cython.pyx":89
 *                   File2.write(str(time)+', '+str(counter)+'\n')
 *         output1 = str(time)+','+str(x)+','+str(y)+','+str(counter) +','+str(entropy_sum/e_s)+'\n';
 *         File1.write(output1)             # <<<<<<<<<<<<<<
 *     File1.close()
 ...
 */
  ...
  /* "Cython_lib/Brusselator_cython.pyx":90
 *         output1 = str(time)+','+str(x)+','+str(y)+','+str(counter) +','+str(entropy_sum/e_s)+'\n';
 *         File1.write(output1)
 *     File1.close()             # <<<<<<<<<<<<<<
 *     File2.close()
 ...
 */
  ...
  /* "Cython_lib/Brusselator_cython.pyx":91
 *         File1.write(output1)
 *     File1.close()
 *     File2.close()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (__pyx_t_13) {
    __pyx_t_11 = __Pyx_PyObject_CallOneArg(__pyx_t_1, __pyx_t_13); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 91, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
  } else {
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_par_ini.rcbuffer->pybuffer);
...
/* "Cython_lib/Brusselator_cython.pyx":93
 *     File2.close()
 * 
 * def Brusselator_loopProgress(char* fname1, fname2, fname3, int numberOfReactions, win_threshold1, win_threshold2, np.ndarray[DTYPE2_t, ndim=1] reactionrate, np.ndarray[DTYPE2_t, ndim=1] par_ini):             # <<<<<<<<<<<<<<
...
/* Python wrapper */
static PyObject *__pyx_pw_10Cython_lib_18Brusselator_cython_3Brusselator_loopProgress(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_10Cython_lib_18Brusselator_cython_3Brusselator_loopProgress = {"Brusselator_loopProgress", (PyCFunction)__pyx_pw_10Cython_lib_18Brusselator_cython_3Brusselator_loopProgress, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_10Cython_lib_18Brusselator_cython_3Brusselator_loopProgress(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  char *__pyx_v_fname1;
  PyObject *__pyx_v_fname2 = 0;
  CYTHON_UNUSED PyObject *__pyx_v_fname3 = 0;
  int __pyx_v_numberOfReactions;
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("Brusselator_loopProgress (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_fname1,&__pyx_n_s_fname2,&__pyx_n_s_fname3,&__pyx_n_s_numberOfReactions,&__pyx_n_s_win_threshold1,&__pyx_n_s_win_threshold2,&__pyx_n_s_reactionrate,&__pyx_n_s_par_ini,0};
    PyObject* values[8] = {0,0,0,0,0,0,0,0};
    if (unlikely(__pyx_kwds)) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("Cython_lib.Brusselator_cython.Brusselator_loopProgress", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  ...
  __pyx_r = __pyx_pf_10Cython_lib_18Brusselator_cython_2Brusselator_loopProgress(__pyx_self, __pyx_v_fname1, __pyx_v_fname2, __pyx_v_fname3, __pyx_v_numberOfReactions, __pyx_v_win_threshold1, __pyx_v_win_threshold2, __pyx_v_reactionrate, __pyx_v_par_ini);
...
static PyObject *__pyx_pf_10Cython_lib_18Brusselator_cython_2Brusselator_loopProgress(CYTHON_UNUSED PyObject *__pyx_self, char *__pyx_v_fname1, PyObject *__pyx_v_fname2, CYTHON_UNUSED PyObject *__pyx_v_fname3, int __pyx_v_numberOfReactions, PyObject *__pyx_v_win_threshold1, PyObject *__pyx_v_win_threshold2, PyArrayObject *__pyx_v_reactionrate, PyArrayObject *__pyx_v_par_ini) {
  double __pyx_v_a;
  double __pyx_v_b;
  double __pyx_v_c;
  double __pyx_v_k1;
  ...
  int __pyx_v_i;
  int __pyx_v_h;
  double __pyx_v_action_rate[6];
  double __pyx_v_sum_rate[6];
  double __pyx_v_time0;
  double __pyx_v_current[6];
  double __pyx_v_entropy_sum;
  double __pyx_v_entropy;
  ...
  __Pyx_RefNannySetupContext("Brusselator_loopProgress", 0);
  __pyx_pybuffer_reactionrate.pybuffer.buf = NULL;
  __pyx_pybuffer_reactionrate.refcount = 0;
  __pyx_pybuffernd_reactionrate.data = NULL;
  __pyx_pybuffernd_reactionrate.rcbuffer = &__pyx_pybuffer_reactionrate;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_reactionrate.rcbuffer->pybuffer, (PyObject*)__pyx_v_reactionrate, &__Pyx_TypeInfo_nn___pyx_t_10Cython_lib_18Brusselator_cython_DTYPE2_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 93, __pyx_L1_error)
  }
  __pyx_pybuffernd_reactionrate.diminfo[0].strides = __pyx_pybuffernd_reactionrate.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_reactionrate.diminfo[0].shape = __pyx_pybuffernd_reactionrate.rcbuffer->pybuffer.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_par_ini.rcbuffer->pybuffer, (PyObject*)__pyx_v_par_ini, &__Pyx_TypeInfo_nn___pyx_t_10Cython_lib_18Brusselator_cython_DTYPE2_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 93, __pyx_L1_error)
  }
  __pyx_pybuffernd_par_ini.diminfo[0].strides = __pyx_pybuffernd_par_ini.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_par_ini.diminfo[0].shape = __pyx_pybuffernd_par_ini.rcbuffer->pybuffer.shape[0];

  /* "Cython_lib/Brusselator_cython.pyx":98
 *     cdef double action_rate[6], sum_rate[6], time0, current[6], entropy_sum, entropy,e_s
 * 
 *     x, y, v, step = par_ini             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "Cython_lib/Brusselator_cython.pyx":99
 * 
 *     x, y, v, step = par_ini
 *     a, b, c, k1, k2, k3, k_1, k_2, k_3 = reactionrate             # <<<<<<<<<<<<<<
 *    # print R, X, MR, Mp, MpK,M
 ...
 */
  if ((likely(PyTuple_CheckExact(((PyObject *)__pyx_v_reactionrate)))) || (PyList_CheckExact(((PyObject *)__pyx_v_reactionrate)))) {
    ...
    for (index=0; index < 9; index++) {
      PyObject* item = __pyx_t_6(__pyx_t_15); if (unlikely(!item)) goto __pyx_L5_unpacking_failed;
      __Pyx_GOTREF(item);
      *(temps[index]) = item;
    }
  ...
  __pyx_v_k3 = __pyx_t_17;
  __pyx_v_k_1 = __pyx_t_18;
  __pyx_v_k_2 = __pyx_t_19;
  __pyx_v_k_3 = __pyx_t_20;

  /* "Cython_lib/Brusselator_cython.pyx":101
 *     a, b, c, k1, k2, k3, k_1, k_2, k_3 = reactionrate
 *    # print R, X, MR, Mp, MpK,M
 *     File1 = open(fname1,"w")             # <<<<<<<<<<<<<<
 *     File1.write('time, x, y, counter, entropy \n')
 ...
 */
  ...
  /* "Cython_lib/Brusselator_cython.pyx":102
 *    # print R, X, MR, Mp, MpK,M
 *     File1 = open(fname1,"w")
 *     File1.write('time, x, y, counter, entropy \n')             # <<<<<<<<<<<<<<
 *     File2 = open(fname2,"w")
 ...
 */
  ...
  /* "Cython_lib/Brusselator_cython.pyx":103
 *     File1 = open(fname1,"w")
 *     File1.write('time, x, y, counter, entropy \n')
 *     File2 = open(fname2,"w")             # <<<<<<<<<<<<<<
 *     File2.write('time, counter, duration \n')
 ...
 */
  ...
  __Pyx_INCREF(__pyx_v_fname2);
  __Pyx_GIVEREF(__pyx_v_fname2);
  PyTuple_SET_ITEM(__pyx_t_13, 0, __pyx_v_fname2);
  __Pyx_INCREF(__pyx_n_s_w);
  __Pyx_GIVEREF(__pyx_n_s_w);
  PyTuple_SET_ITEM(__pyx_t_13, 1, __pyx_n_s_w);
  ...
  /* "Cython_lib/Brusselator_cython.pyx":104
 *     File1.write('time, x, y, counter, entropy \n')
 *     File2 = open(fname2,"w")
 *     File2.write('time, counter, duration \n')             # <<<<<<<<<<<<<<
 *     entropy=0;
 ...
 */
  ...
  /* "Cython_lib/Brusselator_cython.pyx":105
 *     File2 = open(fname2,"w")
 *     File2.write('time, counter, duration \n')
 *     entropy=0;             # <<<<<<<<<<<<<<
 *     action_rate =[a*k1, k_1*x, k2*b*x/v, k_2*c*y/v, k3*x**2*y/v**2,k_3*x**3/v**2]
 ...
 */
  ...
  /* "Cython_lib/Brusselator_cython.pyx":106
 *     File2.write('time, counter, duration \n')
 *     entropy=0;
 *     action_rate =[a*k1, k_1*x, k2*b*x/v, k_2*c*y/v, k3*x**2*y/v**2,k_3*x**3/v**2]             # <<<<<<<<<<<<<<
 *     i=0; time=0.00; counter=0; time0=0; time1=0; counter1=0;
 ...
 */
  ...
  __pyx_t_21[2] = (__pyx_t_20 / __pyx_v_v);
  __pyx_t_21[3] = (__pyx_t_19 / __pyx_v_v);
  __pyx_t_21[4] = (__pyx_t_18 / __pyx_t_17);
  __pyx_t_21[5] = (__pyx_t_16 / __pyx_t_7);
  memcpy(&(__pyx_v_action_rate[0]), __pyx_t_21, sizeof(__pyx_v_action_rate[0]) * (6));

  /* "Cython_lib/Brusselator_cython.pyx":107
 *     entropy=0;
 *     action_rate =[a*k1, k_1*x, k2*b*x/v, k_2*c*y/v, k3*x**2*y/v**2,k_3*x**3/v**2]
 *     i=0; time=0.00; counter=0; time0=0; time1=0; counter1=0;             # <<<<<<<<<<<<<<
 *     for i in xrange(numberOfReactions):
 ...
 */
  ...
  /* "Cython_lib/Brusselator_cython.pyx":108
 *     action_rate =[a*k1, k_1*x, k2*b*x/v, k_2*c*y/v, k3*x**2*y/v**2,k_3*x**3/v**2]
 *     i=0; time=0.00; counter=0; time0=0; time1=0; counter1=0;
 *     for i in xrange(numberOfReactions):             # <<<<<<<<<<<<<<
 *         e_s=0;
 *         entropy_sum=0;
 */
  __pyx_t_22 = __pyx_v_numberOfReactions;
  for (__pyx_t_23 = 0; __pyx_t_23 < __pyx_t_22; __pyx_t_23+=1) {
    __pyx_v_i = __pyx_t_23;

    /* "Cython_lib/Brusselator_cython.pyx":109
 *     i=0; time=0.00; counter=0; time0=0; time1=0; counter1=0;
 *     for i in xrange(numberOfReactions):
 *         e_s=0;             # <<<<<<<<<<<<<<
 *         entropy_sum=0;
 ...
 */
    ...
    /* "Cython_lib/Brusselator_cython.pyx":110
 *     for i in xrange(numberOfReactions):
 *         e_s=0;
 *         entropy_sum=0;             # <<<<<<<<<<<<<<
 *         while time < i/step:
 ...
 */
    ...
    /* "Cython_lib/Brusselator_cython.pyx":111
 *         e_s=0;
 *         entropy_sum=0;
 *         while time < i/step:             # <<<<<<<<<<<<<<
 *               x0=x;
 ...
 */
    while (1) {
      ...
      /* "Cython_lib/Brusselator_cython.pyx":112
 *         entropy_sum=0;
 *         while time < i/step:
 *               x0=x;             # <<<<<<<<<<<<<<
 *               y0=y;
 ...
 */
      ...
      /* "Cython_lib/Brusselator_cython.pyx":113
 *         while time < i/step:
 *               x0=x;
 *               y0=y;             # <<<<<<<<<<<<<<
 *               action_rate =[a*k1, k_1*x, k2*b*x/v, k_2*c*y/v, k3*x**2*y/v**2,k_3*x**3/v**2]
 ...
 */
      ...
      /* "Cython_lib/Brusselator_cython.pyx":114
 *               x0=x;
 *               y0=y;
 *               action_rate =[a*k1, k_1*x, k2*b*x/v, k_2*c*y/v, k3*x**2*y/v**2,k_3*x**3/v**2]             # <<<<<<<<<<<<<<
 *               current=[a*k1, k_1*x, k2*b*x/v, k_2*c*y/v, k3*x**2*y/v**2,k_3*x**3/v**2]
 ...
 */
      ...
      __pyx_t_25[2] = (__pyx_t_7 / __pyx_v_v);
      __pyx_t_25[3] = (__pyx_t_16 / __pyx_v_v);
      __pyx_t_25[4] = (__pyx_t_17 / __pyx_t_18);
      __pyx_t_25[5] = (__pyx_t_19 / __pyx_t_20);
      memcpy(&(__pyx_v_action_rate[0]), __pyx_t_25, sizeof(__pyx_v_action_rate[0]) * (6));

      /* "Cython_lib/Brusselator_cython.pyx":115
 *               y0=y;
 *               action_rate =[a*k1, k_1*x, k2*b*x/v, k_2*c*y/v, k3*x**2*y/v**2,k_3*x**3/v**2]
 *               current=[a*k1, k_1*x, k2*b*x/v, k_2*c*y/v, k3*x**2*y/v**2,k_3*x**3/v**2]             # <<<<<<<<<<<<<<
 *               entropy=0;
 ...
 */
      ...
      __pyx_t_26[2] = (__pyx_t_20 / __pyx_v_v);
      __pyx_t_26[3] = (__pyx_t_19 / __pyx_v_v);
      __pyx_t_26[4] = (__pyx_t_18 / __pyx_t_17);
      __pyx_t_26[5] = (__pyx_t_16 / __pyx_t_7);
      memcpy(&(__pyx_v_current[0]), __pyx_t_26, sizeof(__pyx_v_current[0]) * (6));

      /* "Cython_lib/Brusselator_cython.pyx":116
 *               action_rate =[a*k1, k_1*x, k2*b*x/v, k_2*c*y/v, k3*x**2*y/v**2,k_3*x**3/v**2]
 *               current=[a*k1, k_1*x, k2*b*x/v, k_2*c*y/v, k3*x**2*y/v**2,k_3*x**3/v**2]
 *               entropy=0;             # <<<<<<<<<<<<<<
 *               for h in range(3):
 ...
 */
      ...
      /* "Cython_lib/Brusselator_cython.pyx":117
 *               current=[a*k1, k_1*x, k2*b*x/v, k_2*c*y/v, k3*x**2*y/v**2,k_3*x**3/v**2]
 *               entropy=0;
 *               for h in range(3):             # <<<<<<<<<<<<<<
 *                   entropy=entropy+(current[2*h]-current[2*h+1])*log(current[2*h]/current[2*h+1])
 ...
 */
      for (__pyx_t_27 = 0; __pyx_t_27 < 3; __pyx_t_27+=1) {
        ...
        /* "Cython_lib/Brusselator_cython.pyx":118
 *               entropy=0;
 *               for h in range(3):
 *                   entropy=entropy+(current[2*h]-current[2*h+1])*log(current[2*h]/current[2*h+1])             # <<<<<<<<<<<<<<
 *               if entropy!=float('NaN') and entropy!=float('Inf'):
 *                  entropy_sum=entropy_sum+entropy
 */
        __pyx_t_7 = (__pyx_v_current[(2 * __pyx_v_h)]);
      ...
      /* "Cython_lib/Brusselator_cython.pyx":119
 *               for h in range(3):
 *                   entropy=entropy+(current[2*h]-current[2*h+1])*log(current[2*h]/current[2*h+1])
 *               if entropy!=float('NaN') and entropy!=float('Inf'):             # <<<<<<<<<<<<<<
 *                  entropy_sum=entropy_sum+entropy
 *                  e_s=e_s+1
 */
      __pyx_t_16 = __Pyx_PyObject_AsDouble(__pyx_n_s_NaN); if (unlikely(__pyx_t_16 == ((double)((double)-1)) && PyErr_Occurred())) __PYX_ERR(0, 119, __pyx_L1_error)
      ...
      __pyx_t_16 = __Pyx_PyObject_AsDouble(__pyx_n_s_Inf); if (unlikely(__pyx_t_16 == ((double)((double)-1)) && PyErr_Occurred())) __PYX_ERR(0, 119, __pyx_L1_error)
      __pyx_t_28 = ((__pyx_v_entropy != __pyx_t_16) != 0);
      __pyx_t_24 = __pyx_t_28;
      __pyx_L14_bool_binop_done:;
      if (__pyx_t_24) {

        /* "Cython_lib/Brusselator_cython.pyx":120
 *                   entropy=entropy+(current[2*h]-current[2*h+1])*log(current[2*h]/current[2*h+1])
 *               if entropy!=float('NaN') and entropy!=float('Inf'):
 *                  entropy_sum=entropy_sum+entropy             # <<<<<<<<<<<<<<
 *                  e_s=e_s+1
 ...
 */
        ...
        /* "Cython_lib/Brusselator_cython.pyx":121
 *               if entropy!=float('NaN') and entropy!=float('Inf'):
 *                  entropy_sum=entropy_sum+entropy
 *                  e_s=e_s+1             # <<<<<<<<<<<<<<
 *               for h in range(len(action_rate)):
 ...
 */
      ...
      /* "Cython_lib/Brusselator_cython.pyx":122
 *                  entropy_sum=entropy_sum+entropy
 *                  e_s=e_s+1
 *               for h in range(len(action_rate)):             # <<<<<<<<<<<<<<
 *                    sum_rate[h]=0;
 ...
 */
      ...
      for (__pyx_t_27 = 0; __pyx_t_27 < __pyx_t_29; __pyx_t_27+=1) {
        ...
        /* "Cython_lib/Brusselator_cython.pyx":123
 *                  e_s=e_s+1
 *               for h in range(len(action_rate)):
 *                    sum_rate[h]=0;             # <<<<<<<<<<<<<<
 *               sum_rate[0]=action_rate[0];
 ...
 */
      ...
      /* "Cython_lib/Brusselator_cython.pyx":124
 *               for h in range(len(action_rate)):
 *                    sum_rate[h]=0;
 *               sum_rate[0]=action_rate[0];             # <<<<<<<<<<<<<<
 *               for h in range(len(action_rate)-1):
 ...
 */
      ...
      /* "Cython_lib/Brusselator_cython.pyx":125
 *                    sum_rate[h]=0;
 *               sum_rate[0]=action_rate[0];
 *               for h in range(len(action_rate)-1):             # <<<<<<<<<<<<<<
 *                     sum_rate[h+1] = sum_rate[h]+action_rate[h+1]
 ...
 */
      ...
      for (__pyx_t_27 = 0; __pyx_t_27 < __pyx_t_30; __pyx_t_27+=1) {
        ...
        /* "Cython_lib/Brusselator_cython.pyx":126
 *               sum_rate[0]=action_rate[0];
 *               for h in range(len(action_rate)-1):
 *                     sum_rate[h+1] = sum_rate[h]+action_rate[h+1]             # <<<<<<<<<<<<<<
 *               a0=a*k1+k_1*x+k2*b*x/v+k_2*c*y/v+k3*x**2*y/v**2+k_3*x**3/v**2
 ...
 */
      ...
      /* "Cython_lib/Brusselator_cython.pyx":127
 *               for h in range(len(action_rate)-1):
 *                     sum_rate[h+1] = sum_rate[h]+action_rate[h+1]
 *               a0=a*k1+k_1*x+k2*b*x/v+k_2*c*y/v+k3*x**2*y/v**2+k_3*x**3/v**2             # <<<<<<<<<<<<<<
 *               #print 'sum of rates', sum_rate
 ...
 */
      ...
      /* "Cython_lib/Brusselator_cython.pyx":129
 *               a0=a*k1+k_1*x+k2*b*x/v+k_2*c*y/v+k3*x**2*y/v**2+k_3*x**3/v**2
 *               #print 'sum of rates', sum_rate
 *               rr[0], rr[1]=(rand()+1.00)/(RAND_MAX + 1.00), (rand()+1.00)/(RAND_MAX + 1.00)             # <<<<<<<<<<<<<<
 *               time=time+(1.000/a0)*log(1.000/rr[0]);
 ...
 */
      ...
      /* "Cython_lib/Brusselator_cython.pyx":130
 *               #print 'sum of rates', sum_rate
 *               rr[0], rr[1]=(rand()+1.00)/(RAND_MAX + 1.00), (rand()+1.00)/(RAND_MAX + 1.00)
 *               time=time+(1.000/a0)*log(1.000/rr[0]);             # <<<<<<<<<<<<<<
 * ################################################################################################################
 ...
 */
      ...
      /* "Cython_lib/Brusselator_cython.pyx":132
 *               time=time+(1.000/a0)*log(1.000/rr[0]);
 * ################################################################################################################
 *               if rr[1]*a0<a*k1:   # a*k1             # <<<<<<<<<<<<<<
 *                  x=x+1
 ...
 */
      ...
      if (__pyx_t_24) {
        ...
        /* "Cython_lib/Brusselator_cython.pyx":133
 * ################################################################################################################
 *               if rr[1]*a0<a*k1:   # a*k1
 *                  x=x+1             # <<<<<<<<<<<<<<
 *               elif rr[1]*a0<a*k1+k_1*x:   # k_1*x
 ...
 */
      ...
      /* "Cython_lib/Brusselator_cython.pyx":134
 *               if rr[1]*a0<a*k1:   # a*k1
 *                  x=x+1
 *               elif rr[1]*a0<a*k1+k_1*x:   # k_1*x             # <<<<<<<<<<<<<<
 *                  x=x-1
 ...
 */
      ...
      if (__pyx_t_24) {
        ...
        /* "Cython_lib/Brusselator_cython.pyx":135
 *                  x=x+1
 *               elif rr[1]*a0<a*k1+k_1*x:   # k_1*x
 *                  x=x-1             # <<<<<<<<<<<<<<
 *               elif rr[1]*a0<a*k1+k_1*x+k2*b*x/v:# k2*b*x/v
 ...
 */
      ...
      /* "Cython_lib/Brusselator_cython.pyx":136
 *               elif rr[1]*a0<a*k1+k_1*x:   # k_1*x
 *                  x=x-1
 *               elif rr[1]*a0<a*k1+k_1*x+k2*b*x/v:# k2*b*x/v             # <<<<<<<<<<<<<<
 *                  x=x-1
 ...
 */
      ...
      __pyx_t_24 = ((((__pyx_v_rr[1]) * __pyx_v_a0) < (((__pyx_v_a * __pyx_v_k1) + (__pyx_v_k_1 * __pyx_v_x)) + (__pyx_t_17 / __pyx_v_v))) != 0);
      if (__pyx_t_24) {

        /* "Cython_lib/Brusselator_cython.pyx":137
 *                  x=x-1
 *               elif rr[1]*a0<a*k1+k_1*x+k2*b*x/v:# k2*b*x/v
 *                  x=x-1             # <<<<<<<<<<<<<<
 *                  y=y+1
 ...
 */
        ...
        /* "Cython_lib/Brusselator_cython.pyx":138
 *               elif rr[1]*a0<a*k1+k_1*x+k2*b*x/v:# k2*b*x/v
 *                  x=x-1
 *                  y=y+1             # <<<<<<<<<<<<<<
 *               elif rr[1]*a0<a*k1+k_1*x+k2*b*x/v+k_2*c*y/v:   #k_2*c*y/v
 ...
 */
      ...
      /* "Cython_lib/Brusselator_cython.pyx":139
 *                  x=x-1
 *                  y=y+1
 *               elif rr[1]*a0<a*k1+k_1*x+k2*b*x/v+k_2*c*y/v:   #k_2*c*y/v             # <<<<<<<<<<<<<<
 *                  x=x+1;
 ...
 */
      ...
      __pyx_t_24 = ((((__pyx_v_rr[1]) * __pyx_v_a0) < ((((__pyx_v_a * __pyx_v_k1) + (__pyx_v_k_1 * __pyx_v_x)) + (__pyx_t_17 / __pyx_v_v)) + (__pyx_t_18 / __pyx_v_v))) != 0);
      if (__pyx_t_24) {

        /* "Cython_lib/Brusselator_cython.pyx":140
 *                  y=y+1
 *               elif rr[1]*a0<a*k1+k_1*x+k2*b*x/v+k_2*c*y/v:   #k_2*c*y/v
 *                  x=x+1;             # <<<<<<<<<<<<<<
 *                  y=y-1;
 ...
 */
        ...
        /* "Cython_lib/Brusselator_cython.pyx":141
 *               elif rr[1]*a0<a*k1+k_1*x+k2*b*x/v+k_2*c*y/v:   #k_2*c*y/v
 *                  x=x+1;
 *                  y=y-1;             # <<<<<<<<<<<<<<
 *               elif rr[1]*a0<a*k1+k_1*x+k2*b*x/v+k_2*c*y/v+k3*x**2*y/v**2: #k3*x**2*y/v**2
 ...
 */
      ...
      /* "Cython_lib/Brusselator_cython.pyx":142
 *                  x=x+1;
 *                  y=y-1;
 *               elif rr[1]*a0<a*k1+k_1*x+k2*b*x/v+k_2*c*y/v+k3*x**2*y/v**2: #k3*x**2*y/v**2             # <<<<<<<<<<<<<<
 *                  x=x+1
 *                  y=y-1
 */
      __pyx_t_18 = ((__pyx_v_k2 * __pyx_v_b) * __pyx_v_x);
      if (unlikely(__pyx_v_v == 0)) {
        PyErr_SetString(PyExc_ZeroDivisionError, "float division");
        __PYX_ERR(0, 142, __pyx_L1_error)
      }
      __pyx_t_17 = ((__pyx_v_k_2 * __pyx_v_c) * __pyx_v_y);
      if (unlikely(__pyx_v_v == 0)) {
        PyErr_SetString(PyExc_ZeroDivisionError, "float division");
        __PYX_ERR(0, 142, __pyx_L1_error)
      }
      ...
      __pyx_t_24 = ((((__pyx_v_rr[1]) * __pyx_v_a0) < (((((__pyx_v_a * __pyx_v_k1) + (__pyx_v_k_1 * __pyx_v_x)) + (__pyx_t_18 / __pyx_v_v)) + (__pyx_t_17 / __pyx_v_v)) + (__pyx_t_20 / __pyx_t_19))) != 0);
      if (__pyx_t_24) {

        /* "Cython_lib/Brusselator_cython.pyx":143
 *                  y=y-1;
 *               elif rr[1]*a0<a*k1+k_1*x+k2*b*x/v+k_2*c*y/v+k3*x**2*y/v**2: #k3*x**2*y/v**2
 *                  x=x+1             # <<<<<<<<<<<<<<
 *                  y=y-1
 ...
 */
        ...
        /* "Cython_lib/Brusselator_cython.pyx":144
 *               elif rr[1]*a0<a*k1+k_1*x+k2*b*x/v+k_2*c*y/v+k3*x**2*y/v**2: #k3*x**2*y/v**2
 *                  x=x+1
 *                  y=y-1             # <<<<<<<<<<<<<<
 *               elif rr[1]*a0<a0: # k_3*x**3/v**2
 ...
 */
      ...
      /* "Cython_lib/Brusselator_cython.pyx":145
 *                  x=x+1
 *                  y=y-1
 *               elif rr[1]*a0<a0: # k_3*x**3/v**2             # <<<<<<<<<<<<<<
 *                  x=x-1
 ...
 */
      ...
      if (__pyx_t_24) {
        ...
        /* "Cython_lib/Brusselator_cython.pyx":146
 *                  y=y-1
 *               elif rr[1]*a0<a0: # k_3*x**3/v**2
 *                  x=x-1             # <<<<<<<<<<<<<<
 *                  y=y+1
 ...
 */
        ...
        /* "Cython_lib/Brusselator_cython.pyx":147
 *               elif rr[1]*a0<a0: # k_3*x**3/v**2
 *                  x=x-1
 *                  y=y+1             # <<<<<<<<<<<<<<
 * ################################################################################################################
 ...
 */
      ...
      /* "Cython_lib/Brusselator_cython.pyx":149
 *                  y=y+1
 * ################################################################################################################
 *               if x0 == win_threshold1 and y < win_threshold2 and x==win_threshold1+1 and y0 < win_threshold2:             # <<<<<<<<<<<<<<
 *                   counter=counter+1;
 *                   File2.write(str(time)+', '+str(counter)+','+ str(time-time0)+'\n')
 */
      __pyx_t_13 = PyFloat_FromDouble(__pyx_v_x0); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 149, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_13);
      __pyx_t_14 = PyObject_RichCompare(__pyx_t_13, __pyx_v_win_threshold1, Py_EQ); __Pyx_XGOTREF(__pyx_t_14); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 149, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
      __pyx_t_28 = __Pyx_PyObject_IsTrue(__pyx_t_14); if (unlikely(__pyx_t_28 < 0)) __PYX_ERR(0, 149, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
      if (__pyx_t_28) {
      } else {
        __pyx_t_24 = __pyx_t_28;
      ...
      __pyx_t_14 = PyFloat_FromDouble(__pyx_v_y); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 149, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_14);
      __pyx_t_13 = PyObject_RichCompare(__pyx_t_14, __pyx_v_win_threshold2, Py_LT); __Pyx_XGOTREF(__pyx_t_13); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 149, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
      __pyx_t_28 = __Pyx_PyObject_IsTrue(__pyx_t_13); if (unlikely(__pyx_t_28 < 0)) __PYX_ERR(0, 149, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
      if (__pyx_t_28) {
      } else {
        __pyx_t_24 = __pyx_t_28;
      ...
      __pyx_t_13 = PyFloat_FromDouble(__pyx_v_x); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 149, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_13);
      __pyx_t_14 = __Pyx_PyInt_AddObjC(__pyx_v_win_threshold1, __pyx_int_1, 1, 0); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 149, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_14);
      __pyx_t_12 = PyObject_RichCompare(__pyx_t_13, __pyx_t_14, Py_EQ); __Pyx_XGOTREF(__pyx_t_12); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 149, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
      __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
      __pyx_t_28 = __Pyx_PyObject_IsTrue(__pyx_t_12); if (unlikely(__pyx_t_28 < 0)) __PYX_ERR(0, 149, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
      if (__pyx_t_28) {
      } else {
        __pyx_t_24 = __pyx_t_28;
      ...
      __pyx_t_12 = PyFloat_FromDouble(__pyx_v_y0); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 149, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_12);
      __pyx_t_14 = PyObject_RichCompare(__pyx_t_12, __pyx_v_win_threshold2, Py_LT); __Pyx_XGOTREF(__pyx_t_14); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 149, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
      __pyx_t_28 = __Pyx_PyObject_IsTrue(__pyx_t_14); if (unlikely(__pyx_t_28 < 0)) __PYX_ERR(0, 149, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
      __pyx_t_24 = __pyx_t_28;
      ...
      if (__pyx_t_24) {
        ...
        /* "Cython_lib/Brusselator_cython.pyx":150
 * ################################################################################################################
 *               if x0 == win_threshold1 and y < win_threshold2 and x==win_threshold1+1 and y0 < win_threshold2:
 *                   counter=counter+1;             # <<<<<<<<<<<<<<
 *                   File2.write(str(time)+', '+str(counter)+','+ str(time-time0)+'\n')
 ...
 */
        ...
        /* "Cython_lib/Brusselator_cython.pyx":151
 *               if x0 == win_threshold1 and y < win_threshold2 and x==win_threshold1+1 and y0 < win_threshold2:
 *                   counter=counter+1;
 *                   File2.write(str(time)+', '+str(counter)+','+ str(time-time0)+'\n')             # <<<<<<<<<<<<<<
 *                   time0=time
 *               if x0 == win_threshold1+1 and y < win_threshold2 and x==win_threshold1 and y0 < win_threshold2:
 */
        __pyx_t_12 = __Pyx_PyObject_GetAttrStr(__pyx_v_File2, __pyx_n_s_write); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 151, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_12);
        __pyx_t_13 = PyFloat_FromDouble(__pyx_v_time); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 151, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_13);
        ...
        __pyx_t_13 = 0;
        __pyx_t_13 = __Pyx_PyObject_Call(((PyObject *)(&PyString_Type)), __pyx_t_11, NULL); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 151, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_13);
        __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
        __pyx_t_11 = PyNumber_Add(__pyx_t_13, __pyx_kp_s__3); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 151, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_11);
        __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
        __pyx_t_13 = __Pyx_PyInt_From_int(__pyx_v_counter); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 151, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_13);
        ...
        PyTuple_SET_ITEM(__pyx_t_5, 0, __pyx_t_13);
        __pyx_t_13 = 0;
        __pyx_t_13 = __Pyx_PyObject_Call(((PyObject *)(&PyString_Type)), __pyx_t_5, NULL); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 151, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_13);
        __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
        __pyx_t_5 = PyNumber_Add(__pyx_t_11, __pyx_t_13); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 151, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_5);
        __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
        __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
        __pyx_t_13 = PyNumber_Add(__pyx_t_5, __pyx_kp_s__4); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 151, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_13);
        __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
        __pyx_t_5 = PyFloat_FromDouble((__pyx_v_time - __pyx_v_time0)); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 151, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_5);
        __pyx_t_11 = PyTuple_New(1); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 151, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_11);
        ...
        __pyx_t_5 = 0;
        __pyx_t_5 = __Pyx_PyObject_Call(((PyObject *)(&PyString_Type)), __pyx_t_11, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 151, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_5);
        __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
        __pyx_t_11 = PyNumber_Add(__pyx_t_13, __pyx_t_5); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 151, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_11);
        __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
        __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
        __pyx_t_5 = PyNumber_Add(__pyx_t_11, __pyx_kp_s__5); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 151, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_5);
        __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
        __pyx_t_11 = NULL;
        if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_12))) {
        ...
        if (!__pyx_t_11) {
          __pyx_t_14 = __Pyx_PyObject_CallOneArg(__pyx_t_12, __pyx_t_5); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 151, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
          __Pyx_GOTREF(__pyx_t_14);
        } else {
          #if CYTHON_FAST_PYCALL
          if (PyFunction_Check(__pyx_t_12)) {
            ...
            __pyx_t_14 = __Pyx_PyFunction_FastCall(__pyx_t_12, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 151, __pyx_L1_error)
          ...
          if (__Pyx_PyFastCFunction_Check(__pyx_t_12)) {
            PyObject *__pyx_temp[2] = {__pyx_t_11, __pyx_t_5};
            __pyx_t_14 = __Pyx_PyCFunction_FastCall(__pyx_t_12, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 151, __pyx_L1_error)
            __Pyx_XDECREF(__pyx_t_11); __pyx_t_11 = 0;
            __Pyx_GOTREF(__pyx_t_14);
            __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
          } else
          #endif
          {
            ...
            __pyx_t_5 = 0;
            __pyx_t_14 = __Pyx_PyObject_Call(__pyx_t_12, __pyx_t_13, NULL); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 151, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_14);
            __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
          }
        }
        ...
        /* "Cython_lib/Brusselator_cython.pyx":152
 *                   counter=counter+1;
 *                   File2.write(str(time)+', '+str(counter)+','+ str(time-time0)+'\n')
 *                   time0=time             # <<<<<<<<<<<<<<
 *               if x0 == win_threshold1+1 and y < win_threshold2 and x==win_threshold1 and y0 < win_threshold2:
 ...
 */
      ...
      /* "Cython_lib/Brusselator_cython.pyx":153
 *                   File2.write(str(time)+', '+str(counter)+','+ str(time-time0)+'\n')
 *                   time0=time
 *               if x0 == win_threshold1+1 and y < win_threshold2 and x==win_threshold1 and y0 < win_threshold2:             # <<<<<<<<<<<<<<
 *                   counter=counter-1;
 *                   File2.write(str(time)+', '+str(counter)+'\n')
 */
      __pyx_t_14 = PyFloat_FromDouble(__pyx_v_x0); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 153, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_14);
      __pyx_t_12 = __Pyx_PyInt_AddObjC(__pyx_v_win_threshold1, __pyx_int_1, 1, 0); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 153, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_12);
      __pyx_t_13 = PyObject_RichCompare(__pyx_t_14, __pyx_t_12, Py_EQ); __Pyx_XGOTREF(__pyx_t_13); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 153, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
      __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
      __pyx_t_28 = __Pyx_PyObject_IsTrue(__pyx_t_13); if (unlikely(__pyx_t_28 < 0)) __PYX_ERR(0, 153, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
      if (__pyx_t_28) {
      } else {
        __pyx_t_24 = __pyx_t_28;
      ...
      __pyx_t_13 = PyFloat_FromDouble(__pyx_v_y); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 153, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_13);
      __pyx_t_12 = PyObject_RichCompare(__pyx_t_13, __pyx_v_win_threshold2, Py_LT); __Pyx_XGOTREF(__pyx_t_12); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 153, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
      __pyx_t_28 = __Pyx_PyObject_IsTrue(__pyx_t_12); if (unlikely(__pyx_t_28 < 0)) __PYX_ERR(0, 153, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
      if (__pyx_t_28) {
      } else {
        __pyx_t_24 = __pyx_t_28;
      ...
      __pyx_t_12 = PyFloat_FromDouble(__pyx_v_x); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 153, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_12);
      __pyx_t_13 = PyObject_RichCompare(__pyx_t_12, __pyx_v_win_threshold1, Py_EQ); __Pyx_XGOTREF(__pyx_t_13); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 153, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
      __pyx_t_28 = __Pyx_PyObject_IsTrue(__pyx_t_13); if (unlikely(__pyx_t_28 < 0)) __PYX_ERR(0, 153, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
      if (__pyx_t_28) {
      ...
      __pyx_t_13 = PyFloat_FromDouble(__pyx_v_y0); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 153, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_13);
      __pyx_t_12 = PyObject_RichCompare(__pyx_t_13, __pyx_v_win_threshold2, Py_LT); __Pyx_XGOTREF(__pyx_t_12); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 153, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
      __pyx_t_28 = __Pyx_PyObject_IsTrue(__pyx_t_12); if (unlikely(__pyx_t_28 < 0)) __PYX_ERR(0, 153, __pyx_L1_error)
      ...
      if (__pyx_t_24) {
        ...
        /* "Cython_lib/Brusselator_cython.pyx":154
 *                   time0=time
 *               if x0 == win_threshold1+1 and y < win_threshold2 and x==win_threshold1 and y0 < win_threshold2:
 *                   counter=counter-1;             # <<<<<<<<<<<<<<
 *                   File2.write(str(time)+', '+str(counter)+'\n')
 ...
 */
        ...
        /* "Cython_lib/Brusselator_cython.pyx":155
 *               if x0 == win_threshold1+1 and y < win_threshold2 and x==win_threshold1 and y0 < win_threshold2:
 *                   counter=counter-1;
 *                   File2.write(str(time)+', '+str(counter)+'\n')             # <<<<<<<<<<<<<<
 *         output1 = str(time)+','+str(x)+','+str(y)+','+str(counter) +','+str(entropy_sum/e_s)+'\n';
 *         File1.write(output1)
 */
        __pyx_t_13 = __Pyx_PyObject_GetAttrStr(__pyx_v_File2, __pyx_n_s_write); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 155, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_13);
        __pyx_t_14 = PyFloat_FromDouble(__pyx_v_time); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 155, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_14);
        ...
        __pyx_t_14 = 0;
        __pyx_t_14 = __Pyx_PyObject_Call(((PyObject *)(&PyString_Type)), __pyx_t_5, NULL); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 155, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_14);
        __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
        __pyx_t_5 = PyNumber_Add(__pyx_t_14, __pyx_kp_s__3); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 155, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_5);
        __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
        __pyx_t_14 = __Pyx_PyInt_From_int(__pyx_v_counter); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 155, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_14);
        ...
        __pyx_t_14 = 0;
        __pyx_t_14 = __Pyx_PyObject_Call(((PyObject *)(&PyString_Type)), __pyx_t_11, NULL); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 155, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_14);
        __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
        __pyx_t_11 = PyNumber_Add(__pyx_t_5, __pyx_t_14); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 155, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_11);
        __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
        __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
        __pyx_t_14 = PyNumber_Add(__pyx_t_11, __pyx_kp_s__5); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 155, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_14);
        __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
        __pyx_t_11 = NULL;
        ...
        if (!__pyx_t_11) {
          __pyx_t_12 = __Pyx_PyObject_CallOneArg(__pyx_t_13, __pyx_t_14); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 155, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
          __Pyx_GOTREF(__pyx_t_12);
        } else {
          #if CYTHON_FAST_PYCALL
          if (PyFunction_Check(__pyx_t_13)) {
            ...
            __pyx_t_12 = __Pyx_PyFunction_FastCall(__pyx_t_13, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 155, __pyx_L1_error)
            __Pyx_XDECREF(__pyx_t_11); __pyx_t_11 = 0;
            __Pyx_GOTREF(__pyx_t_12);
            __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
          } else
          ...
          if (__Pyx_PyFastCFunction_Check(__pyx_t_13)) {
            PyObject *__pyx_temp[2] = {__pyx_t_11, __pyx_t_14};
            __pyx_t_12 = __Pyx_PyCFunction_FastCall(__pyx_t_13, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 155, __pyx_L1_error)
            __Pyx_XDECREF(__pyx_t_11); __pyx_t_11 = 0;
            __Pyx_GOTREF(__pyx_t_12);
            __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
          } else
          #endif
          {
            ...
            __pyx_t_14 = 0;
            __pyx_t_12 = __Pyx_PyObject_Call(__pyx_t_13, __pyx_t_5, NULL); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 155, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_12);
            __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
          }
        }
 ...
 */
    ...
    /* "Cython_lib/Brusselator_cython.pyx":156
 *                   counter=counter-1;
 *                   File2.write(str(time)+', '+str(counter)+'\n')
 *         output1 = str(time)+','+str(x)+','+str(y)+','+str(counter) +','+str(entropy_sum/e_s)+'\n';             # <<<<<<<<<<<<<<
 *         File1.write(output1)
 *     File1.close()
 */
    __pyx_t_12 = PyFloat_FromDouble(__pyx_v_time); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 156, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_12);
    __pyx_t_13 = PyTuple_New(1); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 156, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_13);
    __Pyx_GIVEREF(__pyx_t_12);
    PyTuple_SET_ITEM(__pyx_t_13, 0, __pyx_t_12);
    __pyx_t_12 = 0;
    __pyx_t_12 = __Pyx_PyObject_Call(((PyObject *)(&PyString_Type)), __pyx_t_13, NULL); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 156, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_12);
    __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
    __pyx_t_13 = PyNumber_Add(__pyx_t_12, __pyx_kp_s__4); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 156, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_13);
    __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
    __pyx_t_12 = PyFloat_FromDouble(__pyx_v_x); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 156, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_12);
    ...
    PyTuple_SET_ITEM(__pyx_t_5, 0, __pyx_t_12);
    __pyx_t_12 = 0;
    __pyx_t_12 = __Pyx_PyObject_Call(((PyObject *)(&PyString_Type)), __pyx_t_5, NULL); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 156, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_12);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_5 = PyNumber_Add(__pyx_t_13, __pyx_t_12); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 156, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
    __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
    __pyx_t_12 = PyNumber_Add(__pyx_t_5, __pyx_kp_s__4); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 156, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_12);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_5 = PyFloat_FromDouble(__pyx_v_y); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 156, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_13 = PyTuple_New(1); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 156, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_13);
    __Pyx_GIVEREF(__pyx_t_5);
    ...
    __pyx_t_5 = 0;
    __pyx_t_5 = __Pyx_PyObject_Call(((PyObject *)(&PyString_Type)), __pyx_t_13, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 156, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
    __pyx_t_13 = PyNumber_Add(__pyx_t_12, __pyx_t_5); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 156, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_13);
    __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_5 = PyNumber_Add(__pyx_t_13, __pyx_kp_s__4); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 156, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
    __pyx_t_13 = __Pyx_PyInt_From_int(__pyx_v_counter); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 156, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_13);
    ...
    PyTuple_SET_ITEM(__pyx_t_12, 0, __pyx_t_13);
    __pyx_t_13 = 0;
    __pyx_t_13 = __Pyx_PyObject_Call(((PyObject *)(&PyString_Type)), __pyx_t_12, NULL); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 156, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_13);
    __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
    __pyx_t_12 = PyNumber_Add(__pyx_t_5, __pyx_t_13); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 156, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_12);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
    __pyx_t_13 = PyNumber_Add(__pyx_t_12, __pyx_kp_s__4); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 156, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_13);
    __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
    if (unlikely(__pyx_v_e_s == 0)) {
      PyErr_SetString(PyExc_ZeroDivisionError, "float division");
      __PYX_ERR(0, 156, __pyx_L1_error)
    }
    __pyx_t_12 = PyFloat_FromDouble((__pyx_v_entropy_sum / __pyx_v_e_s)); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 156, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_12);
    __pyx_t_5 = PyTuple_New(1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 156, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_GIVEREF(__pyx_t_12);
    ...
    __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
    __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
    __pyx_t_12 = PyNumber_Add(__pyx_t_5, __pyx_kp_s__5); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 156, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_12);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __Pyx_XDECREF_SET(__pyx_v_output1, __pyx_t_12);
    __pyx_t_12 = 0;

    /* "Cython_lib/Brusselator_cython.pyx":157
 *                   File2.write(str(time)+', '+str(counter)+'\n')
 *         output1 = str(time)+','+str(x)+','+str(y)+','+str(counter) +','+str(entropy_sum/e_s)+'\n';
 *         File1.write(output1)             # <<<<<<<<<<<<<<
 *     File1.close()
 *     File2.close()
 */
    __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_v_File1, __pyx_n_s_write); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 157, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_13 = NULL;
    ...
    if (!__pyx_t_13) {
      __pyx_t_12 = __Pyx_PyObject_CallOneArg(__pyx_t_5, __pyx_v_output1); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 157, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_12);
    } else {
      #if CYTHON_FAST_PYCALL
      if (PyFunction_Check(__pyx_t_5)) {
        PyObject *__pyx_temp[2] = {__pyx_t_13, __pyx_v_output1};
        __pyx_t_12 = __Pyx_PyFunction_FastCall(__pyx_t_5, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 157, __pyx_L1_error)
      ...
      if (__Pyx_PyFastCFunction_Check(__pyx_t_5)) {
        PyObject *__pyx_temp[2] = {__pyx_t_13, __pyx_v_output1};
        __pyx_t_12 = __Pyx_PyCFunction_FastCall(__pyx_t_5, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 157, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_13); __pyx_t_13 = 0;
        __Pyx_GOTREF(__pyx_t_12);
      } else
      #endif
      {
        ...
        __pyx_t_12 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_t_14, NULL); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 157, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_12);
        __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
      }
    }
  ...
  /* "Cython_lib/Brusselator_cython.pyx":158
 *         output1 = str(time)+','+str(x)+','+str(y)+','+str(counter) +','+str(entropy_sum/e_s)+'\n';
 *         File1.write(output1)
 *     File1.close()             # <<<<<<<<<<<<<<
 *     File2.close()
 *     return 0
 */
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_v_File1, __pyx_n_s_close); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 158, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_14 = NULL;
  if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_5))) {
  ...
  if (__pyx_t_14) {
    __pyx_t_12 = __Pyx_PyObject_CallOneArg(__pyx_t_5, __pyx_t_14); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 158, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
  } else {
    __pyx_t_12 = __Pyx_PyObject_CallNoArg(__pyx_t_5); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 158, __pyx_L1_error)
  }
  __Pyx_GOTREF(__pyx_t_12);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;

  /* "Cython_lib/Brusselator_cython.pyx":159
 *         File1.write(output1)
 *     File1.close()
 *     File2.close()             # <<<<<<<<<<<<<<
 *     return 0
 */
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_v_File2, __pyx_n_s_close); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 159, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_14 = NULL;
  if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_5))) {
    __pyx_t_14 = PyMethod_GET_SELF(__pyx_t_5);
  ...
  /* "Cython_lib/Brusselator_cython.pyx":160
 *     File1.close()
 *     File2.close()
 *     return 0             # <<<<<<<<<<<<<<
 */
...
static int __pyx_pymod_exec_Brusselator_cython(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_Brusselator_cython},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  {&__pyx_n_s_Brusse_Barato_loopProgress, __pyx_k_Brusse_Barato_loopProgress, sizeof(__pyx_k_Brusse_Barato_loopProgress), 0, 0, 1, 1},
  {&__pyx_n_s_Brusselator_loopProgress, __pyx_k_Brusselator_loopProgress, sizeof(__pyx_k_Brusselator_loopProgress), 0, 0, 1, 1},
  {&__pyx_n_s_Cython_lib_Brusselator_cython, __pyx_k_Cython_lib_Brusselator_cython, sizeof(__pyx_k_Cython_lib_Brusselator_cython), 0, 0, 1, 1},
  {&__pyx_kp_s_Cython_lib_Brusselator_cython_py, __pyx_k_Cython_lib_Brusselator_cython_py, sizeof(__pyx_k_Cython_lib_Brusselator_cython_py), 0, 0, 1, 0},
  ...
  {&__pyx_kp_s_time_x_y_counter_entropy, __pyx_k_time_x_y_counter_entropy, sizeof(__pyx_k_time_x_y_counter_entropy), 0, 0, 1, 0},
 ...
 *     cdef int N, counter, counter1, i, j,n_c, h, particle
 */
  __pyx_tuple__17 = PyTuple_Pack(44, __pyx_n_s_fname1, __pyx_n_s_fname2, __pyx_n_s_fname3, __pyx_n_s_numberOfReactions, __pyx_n_s_win_threshold1, __pyx_n_s_win_threshold2, __pyx_n_s_reactionrate, __pyx_n_s_par_ini, __pyx_n_s_a, __pyx_n_s_b, __pyx_n_s_k1, __pyx_n_s_k2, __pyx_n_s_k3, __pyx_n_s_k_1, __pyx_n_s_k_2, __pyx_n_s_k_3, __pyx_n_s_x, __pyx_n_s_y, __pyx_n_s_time, __pyx_n_s_rr, __pyx_n_s_step, __pyx_n_s_v, __pyx_n_s_time1, __pyx_n_s_N, __pyx_n_s_counter, __pyx_n_s_counter1, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_n_c, __pyx_n_s_h, __pyx_n_s_particle, __pyx_n_s_action_rate, __pyx_n_s_sum_rate, __pyx_n_s_time0, __pyx_n_s_current, __pyx_n_s_entropy_sum, __pyx_n_s_entropy, __pyx_n_s_e_s, __pyx_n_s_File1, __pyx_n_s_File2, __pyx_n_s_x0, __pyx_n_s_y0, __pyx_n_s_a0, __pyx_n_s_output1); if (unlikely(!__pyx_tuple__17)) __PYX_ERR(0, 33, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__17);
  __Pyx_GIVEREF(__pyx_tuple__17);
  __pyx_codeobj__18 = (PyObject*)__Pyx_PyCode_New(8, 0, 44, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__17, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Cython_lib_Brusselator_cython_py, __pyx_n_s_Brusse_Barato_loopProgress, 33, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__18)) __PYX_ERR(0, 33, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initBrusselator_cython(void); /*proto*/
PyMODINIT_FUNC initBrusselator_cython(void)
#else
PyMODINIT_FUNC PyInit_Brusselator_cython(void); /*proto*/
PyMODINIT_FUNC PyInit_Brusselator_cython(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_Brusselator_cython(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_Brusselator_cython(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("Brusselator_cython", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_Cython_lib__Brusselator_cython) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "Cython_lib.Brusselator_cython")) {
      if (unlikely(PyDict_SetItemString(modules, "Cython_lib.Brusselator_cython", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "Cython_lib/Brusselator_cython.pyx":3
 ...
 */
  ...
  /* "Cython_lib/Brusselator_cython.pyx":5
 * import numpy as np
 * cimport numpy as np
 * import time             # <<<<<<<<<<<<<<
 * cimport cython
 ...
 */
  ...
  /* "Cython_lib/Brusselator_cython.pyx":26
 ...
 */
  ...
  /* "Cython_lib/Brusselator_cython.pyx":29
 * ctypedef np.int_t DTYPE_t
 * 
 * DTYPE2 = np.float             # <<<<<<<<<<<<<<
 * ctypedef np.float_t DTYPE2_t
 ...
 *     cdef int N, counter, counter1, i, j,n_c, h, particle
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_10Cython_lib_18Brusselator_cython_1Brusse_Barato_loopProgress, NULL, __pyx_n_s_Cython_lib_Brusselator_cython); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 33, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *     cdef int N, counter, counter1, i, j,n_c, h, particle
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_10Cython_lib_18Brusselator_cython_3Brusselator_loopProgress, NULL, __pyx_n_s_Cython_lib_Brusselator_cython); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 93, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_Brusselator_loopProgress, __pyx_t_1) < 0) __PYX_ERR(0, 93, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "Cython_lib/Brusselator_cython.pyx":1
 * # module for the loops in Gillespie algorithm             # <<<<<<<<<<<<<<
 * # python cython_setup.py build_ext --inplace
 * import numpy as np
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init Cython_lib.Brusselator_cython", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init Cython_lib.Brusselator_cython");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
