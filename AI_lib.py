...
import time
import seaborn
from AI_Cython.Activator_inhibitor_cython import loopProgress
from scipy.integrate import odeint
import pylab as plt
import numpy as np
import time
...
# determinstic values      
    ...
    def determinstic_simulation(self,):
        ...
        #peakind = peakutils.peak.indexes(M_sol, thres=7.0/max(M_sol), min_dist=20)
        #peakind_scipy = signal.find_peaks_cwt(M_sol, np.arange(1,10))
